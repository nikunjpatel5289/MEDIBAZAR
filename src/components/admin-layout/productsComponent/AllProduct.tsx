        ...
        <table className="min-w-full bg-gray-200 font-[sans-serif] rounded-xl">
          <thead className="whitespace-nowrap">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold cursor-pointer text-black" onClick={() => setSort("prodQty")}>
                Stock
                <svg
              ...
              <th className="px-6 py-4 text-left text-sm font-semibold cursor-pointer text-black" onClick={() => setSort("prodPrice")}>
                Amount
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-3 h-3 fill-gray-400 inline ml-1"
