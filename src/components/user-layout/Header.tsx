...
export default function Header() {
  ...
  return (
    ...
    //             className={
    //               route == "/"
    //                 ? "block py-2 px-3 text-white rounded md:bg-transparent md:dark:text-blue-500 md:text-blue-700 md:p-0"
    //                 : "block py-2 px-3 text-white rounded md:bg-transparent md:p-0 md:hover:text-blue-700 md:dark:hover:text-blue-500"
    //             }
