...
interface prop {
  data: Array<{}>;
  handelReviewGet: () => void;
}

const ProductReviewDisplay = ({ handelReviewGet, data }: prop) => {
  useEffect(() => {
    handelReviewGet();
  }, []);
  return (
                  ...
                  return (
                    <div className="pt-10 pb-8 border-b border-gray-100 max-xl:max-w-2xl max-xl:mx-auto" key={idx}>
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        {Array.from({ length: 5 - item.rate }, (_, index) => (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width={30}
                            height={30}
                      ...
                      <div className="flex sm:items-center flex-col min-[400px]:flex-row justify-between gap-5 mb-4">
                        <div className="flex items-center gap-3">
                          <img
                            ...
                            src={
                              item.userID.profile === ""
                                ? "http://res.cloudinary.com/dwqckx7cr/image/upload/v1712302912/Users/nupt0uiro3u8q0moiesj.jpg"
                                : item.userID.profile
                            }
                            alt="John image"
                            className="w-9 h-9 rounded"
                          />
                          <h6 className="font-semibold mt-2 text-lg leading-8 text-indigo-600 ">
                            {item.userID.firstName.toLocaleUpperCase() +
                              " " +
                              item.userID.lastName.toLocaleUpperCase()}
                          </h6>
                        </div>
